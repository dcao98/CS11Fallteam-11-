public class Recommendation{
  public static void main (String []args){
    ...
    String restaurant = TextIO.getlnString();
      if (a == korean){
        System.out.println("Since you and " +celebrity+ "like Korean food,");
